...
/***/ function(module, exports, __webpack_require__) {
	...
	var Grid = React.createClass({displayName: "Grid",
	  ...
	  getEmojiRow:function() {
	    ...
	    return emojis.map(function(e)  {
	      return (
	        React.createElement("span", {style: {display: 'inline-block', width: '20px', height: '20px'}}, e)
	      );
	    });
	  },
	  ...
	  render:function() {
	    ...
	    rows = rows.map(function(r)  {
	      return React.createElement("div", {style: {height: 20, whiteSpace: 'nowrap'}}, r)
	    });
	...
	window.onload = function() {
	  React.render(React.createElement(Grid, null), document.body);
	};
