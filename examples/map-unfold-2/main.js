...
//     adjust(last,d){
//         return {scroll_top: d.pct_scroll};
//     }
//     componentDidMount(){
//     }
//     render(){
...
//         return (
//           <Flipbook id="foo" className="bg-slide" scrollTop={this.state.scroll_top} scrollHeight={1} urls={["barbie-gif/frame_0.gif","barbie-gif/frame_1.gif","barbie-gif/frame_2.gif"]} style={{position:"fixed", zIndex: 98}} imageWidth="100%" fadeInFn={fadeIn} fadeOutFn={fadeOut} step={0.001}/>
//         )
//     }
// }
